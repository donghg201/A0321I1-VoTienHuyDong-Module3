...
public class House_Service extends Service {
    ...
    public House_Service(String service_name, int service_area, double service_cost, int service_max_people, int rent_type_id, String standard_room, String description_other_convinience, int number_of_floors) {
