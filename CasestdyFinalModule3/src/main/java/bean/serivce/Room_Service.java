...
public class Room_Service extends Service {
    ...
    public Room_Service(String service_name, int service_area, double service_cost, int service_max_people, int rent_type_id, int service_type_id, String attach_service_bonus) {
        super(service_name, service_area, service_cost, service_max_people, rent_type_id, service_type_id);
        this.attach_service_bonus = attach_service_bonus;
    }
